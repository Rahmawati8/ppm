...
if (isset($_POST['kirim'])) {
    ...
    $target_dir = 'foto/';
    $target_file = $targe_dir . basename($_FILES['foto']['name']);
    if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
       $query ="insert into pengaduan values (
        ...
        $q = mysql_query($konek, $query);
        if ($q) {
            $pesan = "<div class'alert alert-succes'>pengaduan berhasil dikirim.</div>";
        } else {
...
<div class="row">
  <div class="col-md-12">
    <div class="card">
     ...
     <div class="form-group">
       <textarea name="" id="" cols="30" rows="10" class="form-control" placeholder="Tulis isi laporan di sini..."required></textarea>
     </div>
     <div class="form-group">
